...
public class MobileMessageSend {
    ...
    private static final String APP_KEY="af10a40b4a1d401c53f45f00e64ad2ea";//账号
    private static final String APP_SECRET="0dd2836a82bf";//密钥
    private static final String NONCE="123456";//随机数
    private static final String MOULD_ID="3963264";//模板ID
