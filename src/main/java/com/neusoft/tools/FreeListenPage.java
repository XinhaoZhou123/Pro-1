...
public class FreeListenPage extends Page{
	private  static int  freePageNum = 2; //每一页显示的数量
	private  static  int freePageListNum = 9;//底部分页导航显示从1开始
	//默认
	public FreeListenPage(int currentPage,int num){		
	super(freePageNum,freePageListNum,currentPage,num);
	}
	//可自定义每页显示的数量和底部导航显示数
	public FreeListenPage(int freePageNum,int freePageListNum,int currentPage,int num){		
		super(freePageNum,freePageListNum,currentPage,num);
		display();
	}	
	public void display(){
